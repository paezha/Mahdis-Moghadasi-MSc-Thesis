...
\midrule
\cellcolor{gray!10}{Activity-based} & \cellcolor{gray!10}{Murphy and Owen (2019)} & \cellcolor{gray!10}{Gap in Cumulative Access to Job Opportunities: A Comparative Analysis of LTS 1-4 Based on Weighted Accessibility by Worker Count} & \cellcolor{gray!10}{20 mins (Tested 5 to 6 mins)} & \cellcolor{gray!10}{Census block centroids} & \cellcolor{gray!10}{Neighbourhoods -> city level} & \cellcolor{gray!10}{Network travel time 15 km/h} & \cellcolor{gray!10}{Normative}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{Wu, Lu et al. (2019)} & \cellcolor{gray!10}{Utilizing a Gravity-Based Approach: Evaluating Accessibility to Points of Interest at Metro Stations through a Lognormal Distance Decay Function (Validated by the Distribution of Bicycle-Metro Trip Data)} & \cellcolor{gray!10}{2.5 Km} & \cellcolor{gray!10}{Metro stations (origins) POIs (destinations)} & \cellcolor{gray!10}{2.5 km buffer} & \cellcolor{gray!10}{Euclidean distance} & \cellcolor{gray!10}{Normative}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{Pérez, Buck et al. (2017)} & \cellcolor{gray!10}{1. Dedicated Cycling Network Accessibility: The distance from the centroid of each census tract to the closest segment of the bicycle network was evaluated to ascertain the accessibility level of the respective tracts. 2. Traffic Stress Assessment: The Level of Traffic Stress (LTS) network was employed to gauge accessibility within the district.} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{census tract centroid to nearest bike network} & \cellcolor{gray!10}{The District of Columbia} & \cellcolor{gray!10}{Euclidean distance} & \cellcolor{gray!10}{Positive}\\
\addlinespace
...
\multicolumn{1}{c}{\textbf{Metric Type}} & \multicolumn{1}{>{\centering\arraybackslash}p{5cm}}{\textbf{Study}} & \multicolumn{1}{>{\centering\arraybackslash}p{5cm}}{\textbf{Measure}} & \multicolumn{1}{>{\centering\arraybackslash}p{5cm}}{\textbf{Travel Time/Distance}} & \multicolumn{1}{>{\centering\arraybackslash}p{5cm}}{\textbf{Origins/Destinations}} & \multicolumn{1}{>{\centering\arraybackslash}p{5cm}}{\textbf{Geographic Scale}} & \multicolumn{1}{c}{\textbf{Travel Calculation}} & \multicolumn{1}{c}{\textbf{positive/normative implementations}}\\
\midrule
\cellcolor{gray!10}{Activity-based} & \cellcolor{gray!10}{Cheng, Caset et al. (2019)} & \cellcolor{gray!10}{Cumulative Accessibility Opportunities: Evaluation of chess/card rooms and urban parks catered to both senior and younger adults. The park areas were assessed and given weight according to their dimensions} & \cellcolor{gray!10}{Variable Distance Thresholds: These were determined by considering both geographical location and socio-economic factors} & \cellcolor{gray!10}{Locations derived from the travel survey (as origins) include parks and chess/card rooms (as destinations)} & \cellcolor{gray!10}{Traffic analysis zones} & \cellcolor{gray!10}{Network distance} & \cellcolor{gray!10}{Positive}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{García-Palomares, Gutiérrez et al. (2013)} & \cellcolor{gray!10}{Quality of Access Indicators for Metro Stations: The evaluation assessed the extent of the population served by these stations. Furthermore, accessibility was analyzed by distinct age groups, employing a distance decay function tailored to each age category} & \cellcolor{gray!10}{Distance thresholds of 1500m have been computed for various age categories} & \cellcolor{gray!10}{Metro stations serve as the origins, while populations are assessed at the transport-zone level} & \cellcolor{gray!10}{1500m metro station catchment areas} & \cellcolor{gray!10}{Network distance} & \cellcolor{gray!10}{Normative}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{ \vphantom{1}} & \cellcolor{gray!10}{}\\
\addlinespace
 &  &  &  &  &  &  & \\
\cellcolor{gray!10}{Utility-based} & \cellcolor{gray!10}{Blecic, Ivan, et al} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
2013 &  &  &  &  &  &  & \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\cellcolor{gray!10}{Frank's Walkability Index} & \cellcolor{gray!10}{Frank et al. (2005a,b), Frank et al., (2010)} & \cellcolor{gray!10}{Net residential/ Population density} & \cellcolor{gray!10}{Travel-related data have been gleaned from the Census Journey to Work, and this encompasses information pertinent to both specified regions.} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Normative}\\
 &  & Retail floor area ratio & Household Travel Survey Data census-based demographic data &  & \\
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Intersection density} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{ \vphantom{1}} & \cellcolor{gray!10}{}\\
 &  & Land use mix &  &  & \\
\cellcolor{gray!10}{} & \cellcolor{gray!10}{Manaugh and El-Geneidy (2011)} & \cellcolor{gray!10}{Net residential/ Population density} & \cellcolor{gray!10}{Information pertaining to retail entities, encompassing both shopping centers and educational institutions, was meticulously extracted from the comprehensive Dun and Bradstreet business database. Subsequently, this extracted information was synergistically amalgamated with a weighted intersection index to yield a more holistic and representative overview of the retail landscape in the studied regions} & \cellcolor{gray!10}{For each trip purpose, nine distinct models were developed, each employing a different walkability metric in every iteration (Walk Score, walk opportunities, the Walkability Index at four distinct scales, and three variations of sizes for the pedestrian shed connectivity measure)} & \cellcolor{gray!10}{Normative}\\
\addlinespace
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Intersection density} & \cellcolor{gray!10}{Data at the household level, along with characteristics pertaining to travel behavior, have been acquired from the 2003 Montréal Origin–Destination survey to facilitate a detailed and nuanced analysis of prevailing travel patterns and preferences} & \cellcolor{gray!10}{A simplistic gravity-based measure was employed to assign greater weight to proximate locations in comparison to those more distanced} & \cellcolor{gray!10}{}\\
 &  & Land use mix & Census tract level demographic data derived from Statistics Canada &  & \\
\cellcolor{gray!10}{} & \cellcolor{gray!10}{Adhikari et al.,(2021)} & \cellcolor{gray!10}{residential density} & \cellcolor{gray!10}{Demographic characteristics of participants} & \cellcolor{gray!10}{The walkability index employs 1 km pedestrian (walksheds) mapping pedestrian-accessible routes surrounding each postal code centroid} & \cellcolor{gray!10}{Normative}\\
...
\addlinespace
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Land-use mix} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
 &  & Intersection density &  &  & \\
\cellcolor{gray!10}{} & \cellcolor{gray!10}{Azmi et al., (2013)} & \cellcolor{gray!10}{Mixed-use planning} & \cellcolor{gray!10}{Data was gathered by using the questionnaire survey} & \cellcolor{gray!10}{The selection of community facilities or services was contingent upon the availability of services provided within a radius of 400 meters, equivalent to approximately 5 minutes of walking} & \cellcolor{gray!10}{Normative}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Street connectivity} & \cellcolor{gray!10}{The respondents specified the estimated duration they presumed would be required to walk from their residences to the closest destination, thus providing insights into perceived proximity and accessibility to nearby locations or amenities} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
\addlinespace
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Data pertaining to the neighborhood was utilized as a source for acquiring socio-demographic and physical neighborhood variables, serving as control variables in the analysis. These encompassed factors such as gender, age, income status, employment status, household composition, and migratory background, each contributing to a multifaceted understanding of the demographic and social structure of the respective neighborhoods} & \cellcolor{gray!10}{The variables related to facilities are classified into two main categories: firstly, the distance to the closest facility, calculated as the average distance from the central point of the respective neighborhood; secondly, the number of accessible facilities within a 1 km radius originating from the neighborhood's center} & \cellcolor{gray!10}{}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Land Use Mix Variables: Distinct lower-level land-use variables were employed, each expressed as a percentage of the total land area attributed to that specific land-use} & \cellcolor{gray!10}{}\\
...
\addlinespace
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Land use entropy score} & \cellcolor{gray!10}{Land use data, the location of commercial zones, the population, and the characteristics of the walking trips from each zone (TAZ)} & \cellcolor{gray!10}{This metric assesses accessibility to a spectrum of opportunities including shopping, employment, education, and institutions} & \cellcolor{gray!10}{}\\
 &  & Population density &  &  & \\
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Commercial density} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Traffic Safety} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
\addlinespace
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Characters of the roots:Pavement Quality, Pavement width, Slope} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Intersection density metrics} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
 &  & Average block length &  &  & \\
\addlinespace
\cellcolor{gray!10}{The Graz Walkability Index is devised, building upon the foundational structure of the American City and Frank's walkability indices} & \cellcolor{gray!10}{Grasser et al. (2017)} & \cellcolor{gray!10}{Net residential/ Population density/ household density} & \cellcolor{gray!10}{The data pertaining to outcomes were extracted from a survey that is cross-sectional and representative in nature} & \cellcolor{gray!10}{The current research documents the findings associated with both the 1000m circular buffer and the 1500m street network buffer} & \cellcolor{gray!10}{Normative}\\
 &  & Intersection density & Walking (for at least 10 min) and cycling (in the warm season) &  & \\
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Land use mix (entropy index for land-use mix)} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
\bottomrule
\end{longtable}
\endgroup{}
\end{landscape}
...
\midrule
\cellcolor{gray!10}{Lowry, Callister et al. (2012)} & \cellcolor{gray!10}{Moscow, Idaho} & \cellcolor{gray!10}{A bikeability assessment devised based on the widely adopted accessibility equation known as Hansen's model} & \cellcolor{gray!10}{AThe term (bikeway) encompasses any road or pathway that permits bicycle travel, irrespective of whether it incorporates a dedicated bike lane} & \cellcolor{gray!10}{The evaluation of bikeability encompasses the examination of the comfort and safety aspects of the entire bikeway network, specifically in terms of accessing crucial destinations} & \cellcolor{gray!10}{Positive}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{The primary bikeway network under scrutiny in this study is composed solely of arterial roads, collector roads, and shared-use paths, with no inclusion of other road categories for assessment} & \cellcolor{gray!10}{Bikeability was evaluated for each commercial destination within the study area} & \cellcolor{gray!10}{}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{The assessment of accessibility in this study was computed based on the shortest network distance between the starting points of trips} & \cellcolor{gray!10}{This study provides a thorough road and path classification, dividing them into seven distinct categories: roads without dedicated bicycle infrastructure, roads featuring designated bicycle lanes, roads with dedicated bicycle paths protected by curbs and/or separating strips, fully segregated paths catering to both bicycles and pedestrians, fully segregated paths exclusively for pedestrians, roads inaccessible to pedestrians and bicycles, and roads with no public access} & \cellcolor{gray!10}{The average slope of the terrain within the specified distances (measured using Euclidean distance) was taken into account in this analysis} & \cellcolor{gray!10}{}\\
\addlinespace
...
\cellcolor{gray!10}{McNeil (2011)} & \cellcolor{gray!10}{Portland, Oregon} & \cellcolor{gray!10}{The assessment of bike accessibility, commonly referred to as bikeability, within a neighborhood is carried out using a 20-minute neighborhood criterion specifically tailored for bicycles} & \cellcolor{gray!10}{The 2009 National Household Transportation Survey} & \cellcolor{gray!10}{This research primarily concentrated on utilitarian trips originating from homes, excluding any travel to and from workplace} & \cellcolor{gray!10}{Normative}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Information regarding business addresses related to various destination types was acquired from Reference USA, a data clearinghouse} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{}\\
...
\addlinespace
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Using gravity-based measures of accessibility} & \cellcolor{gray!10}{A database consisting of Mesh Blocks from the 2011 Census was utilized, containing information on the total population and number of dwellings in each block} & \cellcolor{gray!10}{The median desirable travel time or distance was utilized in this study} & \cellcolor{gray!10}{}\\
...
\cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{Service area analysis and OD-cost matrix analysis were conducted separately for each set of destinations in this study} & \cellcolor{gray!10}{}\\
...
\midrule
\cellcolor{gray!10}{Activity-based} & \cellcolor{gray!10}{Travel data is usually obtained from surveys and includes information about each trip such as duration, start point, end point, origin and destination.} & \cellcolor{gray!10}{Travel behavior characteristics such as age, gender, income, can be considered if the data are available} & \cellcolor{gray!10}{The origin and destinations spatial data or a database of POIs that is obtained from local map. Indeed, a database of POIs consists of the location of all of the facilities such as home, workplace, parks, schools, groceries, etc.} & \cellcolor{gray!10}{Walking and cycling network data are required for calculating time or distances (using network analysis or nearest distance) that can be obtained from both the OpenStreetMap and the local government data portals.} & \cellcolor{gray!10}{Spatial data of statistical areas such as blocks, mesh, zones, areas, etc. This data set includes some information such as population, number of dwellings, employment data, etc. This dataset is required for calculating accessibility in each area.} & \cellcolor{gray!10}{Impedance functions are required that are usually estimated based on a negative exponential function and it is mostly based on the travel time.}\\
 &  &  &  &  &  & Slope can be considered for calculating accessibility.\\
\cellcolor{gray!10}{Distance-based} & \cellcolor{gray!10}{-----} & \cellcolor{gray!10}{-----} & \cellcolor{gray!10}{Required to calculating the shortest distance to nearest facilities.} & \cellcolor{gray!10}{Required to calculating nearest distance or time to facilities using network analysis.} & \cellcolor{gray!10}{Spatial data of census tracts.} & \cellcolor{gray!10}{}\\
...
\cellcolor{gray!10}{Utility-based} & \cellcolor{gray!10}{Travel data is required} & \cellcolor{gray!10}{Travel behavior characteristics are required such as age, gender, etc.} & \cellcolor{gray!10}{-----} & \cellcolor{gray!10}{Walking and cycling network data are required} & \cellcolor{gray!10}{Spatial data of essential services} & \cellcolor{gray!10}{}\\
\addlinespace
...
\cellcolor{gray!10}{Bikeability} & \cellcolor{gray!10}{Travel data is required and includes information about each trip such as duration, start point, end point, origin and destination} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{The origin and destinations database is required} & \cellcolor{gray!10}{Walking and cycling network data are required for calculating time or distances (using network analysis or nearest distance)} & \cellcolor{gray!10}{Spatial data of statistical areas such as blocks, mesh, zones, areas, etc. is required for calculating accessibility in each area.} & \cellcolor{gray!10}{Impedance functions are required that are usually estimated based on a negative exponential function and it is mostly based on the travel time}\\
\bottomrule
\end{longtable}
\endgroup{}
\end{landscape}
...
\midrule
\cellcolor{gray!10}{General social survey (GSS)} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-}\\
Transportation Tomorrow Survey (TTS) of Toronto & Y & Y & Y & Y & Y & Y\\
\cellcolor{gray!10}{Autorité régionale de transport métropolitain (ARTM) survey of Montreal} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{Y}\\
The Linkable Open Data Environment (LODE) & - & - & Y & - & - & -\\
\cellcolor{gray!10}{Can-BICS} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{Stress Level}\\
\addlinespace
open street map & - & - & - & Y & Y & -\\
\cellcolor{gray!10}{Toronto open data} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-}\\
Vancouver open data & - & - & - & Y & - & -\\
\cellcolor{gray!10}{Montreal open data} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{Y} & \cellcolor{gray!10}{-} & \cellcolor{gray!10}{-}\\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
\cellcolor{gray!10}{Home} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{15} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{45.4} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{58.9} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{5.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{51.2}\\
Other's home & Walking & 1 & 10 & 90 & 43.0 & 1 & 5 & 90 & 21.6 & 1 & 5.0 & 90 & 28.2\\
\cellcolor{gray!10}{Work or school} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{11.5} & \cellcolor{gray!10}{2} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{60} & \cellcolor{gray!10}{19.6} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{6.5} & \cellcolor{gray!10}{75} & \cellcolor{gray!10}{20.5}\\
Home &  & NA & NA & NA & NA & 5 & 20 & 90 & 54.8 & 2 & 15.0 & 90 & 52.9\\
\cellcolor{gray!10}{Work or school} & \cellcolor{gray!10}{cycling} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{15} & \cellcolor{gray!10}{45} & \cellcolor{gray!10}{27.8} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{20.0} & \cellcolor{gray!10}{75} & \cellcolor{gray!10}{29.4}\\
\addlinespace
...
\multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Destination}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Mode}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Minimum}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Median}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Maximum}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Percentage}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Minimum}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Median}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Maximum}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Percentage}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Minimum}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Median}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Maximum}} & \multicolumn{1}{>{\centering\arraybackslash}p{1cm}}{\textbf{Percentage}}\\
\midrule
\cellcolor{gray!10}{Home} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{44.3} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{43.6} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{45.0}\\
Work or school & Walking & 0 & 10.0 & 70 & 17.1 & 0 & 10.0 & 80 & 15.0 & 5 & 10.0 & 80 & 15.2\\
\cellcolor{gray!10}{Grocery store, other stores or mall} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{12.5} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{7.5} & \cellcolor{gray!10}{85} & \cellcolor{gray!10}{13.3} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{11.8}\\
Restaurant, bar or club &  & 0 & 5.0 & 85 & 9.4 & 1 & 5.0 & 90 & 10.0 & 5 & 10.0 & 90 & 8.4\\
\cellcolor{gray!10}{Other's home} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{5.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{11.7} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{5.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{11.4} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{80} & \cellcolor{gray!10}{7.3}\\
\addlinespace
Sports centre, field or arena &  & NA & NA & NA & NA & NA & NA & NA & NA & 5 & 10.0 & 45 & 3.3\\
\cellcolor{gray!10}{Outdoors} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{5.0} & \cellcolor{gray!10}{60} & \cellcolor{gray!10}{3.6} & \cellcolor{gray!10}{0} & \cellcolor{gray!10}{9.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{5.1} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{80} & \cellcolor{gray!10}{2.8}\\
In the neighbourhood &  & NA & NA & NA & NA & NA & NA & NA & NA & 5 & 10.0 & 60 & 2.1\\
\cellcolor{gray!10}{Library, museum or theatre} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{12.5} & \cellcolor{gray!10}{40} & \cellcolor{gray!10}{0.6} & \cellcolor{gray!10}{2} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{40} & \cellcolor{gray!10}{0.7} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{40} & \cellcolor{gray!10}{1.6}\\
Place of worship &  & 1 & 10.0 & 30 & 0.9 & 1 & 8.0 & 60 & 0.9 & 5 & 15.0 & 45 & 1.1\\
\addlinespace
\cellcolor{gray!10}{Medical, dental or other health clinic} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{45} & \cellcolor{gray!10}{1.0}\\
Business &  & NA & NA & NA & NA & NA & NA & NA & NA & 5 & 10.0 & 30 & 0.2\\
\cellcolor{gray!10}{Home} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{15.0} & \cellcolor{gray!10}{75} & \cellcolor{gray!10}{48.5} & \cellcolor{gray!10}{1} & \cellcolor{gray!10}{15.0} & \cellcolor{gray!10}{75} & \cellcolor{gray!10}{50.4} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{20.0} & \cellcolor{gray!10}{80} & \cellcolor{gray!10}{46.2}\\
Work or school & cycling & 1 & 15.0 & 90 & 22.1 & 1 & 15.0 & 85 & 24.3 & 5 & 15.0 & 60 & 28.7\\
\cellcolor{gray!10}{Grocery store, other stores or mall} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{2} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{30} & \cellcolor{gray!10}{10.3} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{10.0} & \cellcolor{gray!10}{75} & \cellcolor{gray!10}{9.1} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{15.0} & \cellcolor{gray!10}{80} & \cellcolor{gray!10}{6.7}\\
\addlinespace
Other's home &  & 1 & 15.0 & 35 & 9.1 & 5 & 10.0 & 45 & 9.6 & 5 & 15.0 & 40 & 5.4\\
\cellcolor{gray!10}{Restaurant, bar or club} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{5} & \cellcolor{gray!10}{20.0} & \cellcolor{gray!10}{35} & \cellcolor{gray!10}{3.0} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{12.5} & \cellcolor{gray!10}{15} & \cellcolor{gray!10}{1.7} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{17.5} & \cellcolor{gray!10}{60} & \cellcolor{gray!10}{4.2}\\
Sports centre, field or arena &  & NA & NA & NA & NA & NA & NA & NA & NA & 10 & 15.0 & 15 & 2.9\\
\cellcolor{gray!10}{Medical, dental or other health clinic} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{15.0} & \cellcolor{gray!10}{90} & \cellcolor{gray!10}{2.1}\\
Outdoors &  & 5 & 15.0 & 45 & 6.1 & 3 & 7.5 & 20 & 3.5 & 15 & 20.0 & 30 & 1.2\\
\addlinespace
\cellcolor{gray!10}{In the neighbourhood} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{10} & \cellcolor{gray!10}{30.0} & \cellcolor{gray!10}{45} & \cellcolor{gray!10}{1.2}\\
Library, museum or theatre &  & 10 & 12.5 & 15 & 0.6 & 10 & 25.0 & 30 & 1.3 & 15 & 15.0 & 15 & 0.8\\
\cellcolor{gray!10}{Place of worship} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{20} & \cellcolor{gray!10}{20.0} & \cellcolor{gray!10}{20} & \cellcolor{gray!10}{0.3} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{15} & \cellcolor{gray!10}{15.0} & \cellcolor{gray!10}{15} & \cellcolor{gray!10}{0.4}\\
\bottomrule
\end{longtable}
\endgroup{}
\end{landscape}
...
\midrule
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Gamma}} & \cellcolor{gray!10}{-3445.93} & \cellcolor{gray!10}{1363.40} & \cellcolor{gray!10}{1369.64} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-3445.93} & \cellcolor{gray!10}{6895.85} & \cellcolor{gray!10}{6905.38} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-2822.99} & \cellcolor{gray!10}{5649.98} & \cellcolor{gray!10}{5659.47} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Weibull}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-3}{*}{\raggedright\arraybackslash Home}}} & \em{\cellcolor{gray!10}{Exponential}} & \cellcolor{gray!10}{-3462.38} & \cellcolor{gray!10}{1387.32} & \cellcolor{gray!10}{1390.43} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-3462.38} & \cellcolor{gray!10}{6926.75} & \cellcolor{gray!10}{6931.52} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-2829.02} & \cellcolor{gray!10}{5660.04} & \cellcolor{gray!10}{5664.78} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{1-14}
...
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-4}{*}{\raggedright\arraybackslash work or school}}} & \em{\cellcolor{gray!10}{Lognormal}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{1-14}
\textbf{} & \em{Gamma} & -1097.09 & 1296.75 & 1302.91 & Gamma & -1097.09 & 2198.17 & 2205.70 & Gamma & -1493.73 & 2991.47 & 2999.76 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Weibull}} & \cellcolor{gray!10}{-1108.03} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-1108.03} & \cellcolor{gray!10}{2220.05} & \cellcolor{gray!10}{2227.58} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-1498.74} & \cellcolor{gray!10}{3001.47} & \cellcolor{gray!10}{3009.77} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{} & \em{Exponential} & -1114.47 & 1312.24 & 1315.32 & Gamma & -1114.47 & 2230.94 & 2234.70 &  & -1499.40 & 3000.80 & 3004.95 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-4}{*}{\raggedright\arraybackslash Other's home}}} & \em{\cellcolor{gray!10}{Lognormal}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma}\\
\bottomrule
\end{tabular}
\end{table}
\end{landscape}
...
Destinations & Distribution Functions & logLik & AIC & BIC & Selected Function & logLik & AIC & BIC & Selected Function & logLik & AIC & BIC & Selected Function\\
\midrule
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Gamma}} & \cellcolor{gray!10}{-8561.05} & \cellcolor{gray!10}{17126.11} & \cellcolor{gray!10}{17137.71} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-6773.82} & \cellcolor{gray!10}{13551.64} & \cellcolor{gray!10}{13562.73} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-4899.43} & \cellcolor{gray!10}{9802.87} & \cellcolor{gray!10}{9813.22} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{} & \em{Weibull} & -8585.21 & 17174.43 & 17186.03 & Gamma & -6785.96 & 13575.91 & 13587.01 & Gamma & -4959.63 & 9923.26 & 9933.61 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-3}{*}{\raggedright\arraybackslash Home}}} & \em{\cellcolor{gray!10}{Exponential}} & \cellcolor{gray!10}{-8618.16} & \cellcolor{gray!10}{17238.32} & \cellcolor{gray!10}{17244.12} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-6791.86} & \cellcolor{gray!10}{13585.73} & \cellcolor{gray!10}{13591.28} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-5050.70} & \cellcolor{gray!10}{10103.41} & \cellcolor{gray!10}{10108.58} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{1-14}
\textbf{} & \em{Gamma} & -3241.56 & 6487.13 & 6496.83 & Gamma & -2243.15 & 4490.30 & 4499.27 & Lognormal & -1697.00 & 3398.00 & 3406.33 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Weibull}} & \cellcolor{gray!10}{-3254.75} & \cellcolor{gray!10}{6513.50} & \cellcolor{gray!10}{6523.20} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-2252.50} & \cellcolor{gray!10}{4509.00} & \cellcolor{gray!10}{4517.97} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{-1721.97} & \cellcolor{gray!10}{3447.95} & \cellcolor{gray!10}{3456.28} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{} & \em{Exponential} & -3277.81 & 6557.62 & 6562.47 & Gamma & -2269.31 & 4540.63 & 4545.11 & Lognormal & -1789.93 & 3581.86 & 3586.02 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-4}{*}{\raggedright\arraybackslash work or school}}} & \em{\cellcolor{gray!10}{Lognormal}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-2229.51} & \cellcolor{gray!10}{4463.03} & \cellcolor{gray!10}{4472.00} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{1-14}
\textbf{} & \em{Gamma} & -2030.84 & 4065.68 & 4074.62 & Lognormal & -1565.60 & 3135.20 & 3143.61 & exponential & -805.12 & 1614.25 & 1621.11 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Weibull}} & \cellcolor{gray!10}{-2035.93} & \cellcolor{gray!10}{4075.86} & \cellcolor{gray!10}{4084.80} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{-1563.85} & \cellcolor{gray!10}{3131.70} & \cellcolor{gray!10}{3140.11} & \cellcolor{gray!10}{exponential} & \cellcolor{gray!10}{-817.06} & \cellcolor{gray!10}{1638.13} & \cellcolor{gray!10}{1644.99} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{} & \em{Exponential} & -2037.41 & 4076.81 & 4081.28 & Lognormal & -1565.64 & 3133.28 & 3137.49 & exponential & -832.40 & 1666.81 & 1670.24 & Gamma\\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-4}{*}{\raggedright\arraybackslash Other's home}}} & \em{\cellcolor{gray!10}{Lognormal}} & \cellcolor{gray!10}{-1996.71} & \cellcolor{gray!10}{3997.42} & \cellcolor{gray!10}{4006.36} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{exponential} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma}\\
\bottomrule
\end{tabular}
\end{table}
\end{landscape}
...
\cmidrule{1-15}
\textbf{\cellcolor{gray!10}{22}} & \em{\cellcolor{gray!10}{Library}} & \cellcolor{gray!10}{Weibull} & \cellcolor{gray!10}{-637.63} & \cellcolor{gray!10}{1279.26} & \cellcolor{gray!10}{1285.84} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-96.99} & \cellcolor{gray!10}{197.97} & \cellcolor{gray!10}{200.71} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-159.04} & \cellcolor{gray!10}{322.08} & \cellcolor{gray!10}{325.79} & \cellcolor{gray!10}{Lognormal}\\
\cmidrule{1-15}
\textbf{23} & \em{Library} & Lognormal & NA & NA & NA & Gamma & -95.82 & 195.63 & 198.36 & Gamma & -153.89 & 311.78 & 315.48 & Lognormal\\
\cmidrule{1-15}
\textbf{\cellcolor{gray!10}{24}} & \em{\cellcolor{gray!10}{Library}} & \cellcolor{gray!10}{Exponential} & \cellcolor{gray!10}{-642.38} & \cellcolor{gray!10}{1286.77} & \cellcolor{gray!10}{1290.05} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-99.43} & \cellcolor{gray!10}{200.87} & \cellcolor{gray!10}{202.24} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-172.58} & \cellcolor{gray!10}{347.16} & \cellcolor{gray!10}{349.01} & \cellcolor{gray!10}{Lognormal}\\
\cmidrule{1-15}
...
\cmidrule{1-15}
\textbf{\cellcolor{gray!10}{26}} & \em{\cellcolor{gray!10}{Restaurant}} & \cellcolor{gray!10}{Exponential} & \cellcolor{gray!10}{-1707.84} & \cellcolor{gray!10}{3417.67} & \cellcolor{gray!10}{3421.92} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{-1480.30} & \cellcolor{gray!10}{2962.59} & \cellcolor{gray!10}{2966.68} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-921.28} & \cellcolor{gray!10}{1844.56} & \cellcolor{gray!10}{1848.08} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{1-15}
\textbf{27} & \em{Restaurant} & Weibull & -1685.20 & 3374.41 & 3382.91 & Lognormal & -1478.49 & 2960.99 & 2969.15 & Gamma & NA & NA & NA & Gamma\\
\cmidrule{1-15}
\textbf{\cellcolor{gray!10}{28}} & \em{\cellcolor{gray!10}{Restaurant}} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{-1657.24} & \cellcolor{gray!10}{3318.48} & \cellcolor{gray!10}{3326.98} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{1-15}
\textbf{29} & \em{Place of worship} & Gamma & -154.97 & 313.93 & 317.63 & Gamma & -131.33 & 266.67 & 270.09 & Gamma & -127.23 & 258.47 & 261.64 & Lognormal\\
\cmidrule{1-15}
\textbf{\cellcolor{gray!10}{30}} & \em{\cellcolor{gray!10}{Place of worship}} & \cellcolor{gray!10}{Exponential} & \cellcolor{gray!10}{-160.42} & \cellcolor{gray!10}{322.85} & \cellcolor{gray!10}{324.70} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-135.90} & \cellcolor{gray!10}{273.81} & \cellcolor{gray!10}{275.52} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-136.37} & \cellcolor{gray!10}{274.74} & \cellcolor{gray!10}{276.33} & \cellcolor{gray!10}{Lognormal}\\
\cmidrule{1-15}
\textbf{31} & \em{Place of worship} & Normal & NA & NA & NA & Gamma & -150.95 & 305.90 & 309.33 & Gamma & -132.78 & 269.56 & 272.73 & Lognormal\\
\cmidrule{1-15}
\textbf{\cellcolor{gray!10}{32}} & \em{\cellcolor{gray!10}{Place of worship}} & \cellcolor{gray!10}{Lognormal} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-139.70} & \cellcolor{gray!10}{283.40} & \cellcolor{gray!10}{286.83} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-127.01} & \cellcolor{gray!10}{258.02} & \cellcolor{gray!10}{261.19} & \cellcolor{gray!10}{Lognormal}\\
\cmidrule{1-15}
...
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Weibull}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-216.67} & \cellcolor{gray!10}{437.34} & \cellcolor{gray!10}{441.35} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-258.10} & \cellcolor{gray!10}{520.20} & \cellcolor{gray!10}{524.67} & \cellcolor{gray!10}{}\\
\cmidrule{2-14}
\textbf{} & \em{Exponential} & -296.38 & 594.77 & 597.06 &  & -222.50 & 446.99 & 449.00 &  & -279.83 & 561.66 & 563.89 & \\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Normal}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-264.66} & \cellcolor{gray!10}{533.33} & \cellcolor{gray!10}{537.80} & \cellcolor{gray!10}{}\\
\cmidrule{2-14}
...
\cmidrule{1-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Gamma}} & \cellcolor{gray!10}{-106.61} & \cellcolor{gray!10}{217.21} & \cellcolor{gray!10}{220.01} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-78.57} & \cellcolor{gray!10}{161.14} & \cellcolor{gray!10}{163.32} & \cellcolor{gray!10}{Gamma} & \cellcolor{gray!10}{-42.17} & \cellcolor{gray!10}{88.34} & \cellcolor{gray!10}{89.47} & \cellcolor{gray!10}{Gamma}\\
\cmidrule{2-14}
\textbf{} & \em{Poisson} & -161.62 & 325.24 & 326.64 &  & -131.33 & 264.66 & 265.75 &  & -51.23 & 104.45 & 105.02 & \\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{}} & \em{\cellcolor{gray!10}{Exponential}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-81.04} & \cellcolor{gray!10}{164.07} & \cellcolor{gray!10}{165.17} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{-47.87} & \cellcolor{gray!10}{97.73} & \cellcolor{gray!10}{98.30} & \cellcolor{gray!10}{}\\
\cmidrule{2-14}
\textbf{} & \em{Normal} & -110.01 & 224.03 & 226.83 &  & -84.37 & 172.74 & 174.93 &  & -45.41 & 94.82 & 95.95 & \\
\cmidrule{2-14}
\textbf{\cellcolor{gray!10}{\multirow[t]{-5}{*}{\raggedright\arraybackslash Other's home}}} & \em{\cellcolor{gray!10}{Lognormal}} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{NA} & \cellcolor{gray!10}{}\\
\bottomrule
\end{tabular}
\end{table}
\end{landscape}
...
Function
2010 & logLik
\textbf{\cellcolor{gray!10}{2015}} & \em{NA} & AIC
2015 & BIC
2015 & Selected
Function
2015\\
