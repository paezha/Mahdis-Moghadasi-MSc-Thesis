...
```{r ch03-load-pkgs, include = FALSE}
...
```{r ch03-load-data, include = FALSE}
...
styled_ch03_table_02 <- wide_data %>%
  kable(
    ...
    booktabs = TRUE, 
    longtable = TRUE, 
    caption = "\\label{tab:ch03-table-02}Comparative Trip Stats by Mode and Destination: 1986, 1992, 1998", # Escaped ampersand
  ...
  column_spec(2:14, width = "0.6cm") %>%  # Set width of remaining columns to 0.7cm
  add_header_above(c(" " = 2, "1986" = 4, "1992" = 4, "1998" = 4)) %>%
  row_spec(0, bold = TRUE, align = "c") %>%
  column_spec(6, border_right = TRUE) %>%
  column_spec(10, border_right = TRUE) %>%
  footnote(
    general = c("* The symbols used in this table represent the following: 'Min' denotes the minimum time to reach the destination; 'Max' denotes the maximum time to reach the destination; 'P' indicates a percentage of the total time to reach the destination; 'Med' refers to the median time to reach the destination."),
    general_title = "Notes: ", # Title for the notes/footnotes section
    threeparttable = TRUE # Use three part table for better spacing of footnotes
  )
...
styled_ch03_table_03 <- wide_data %>%
  ...
  footnote(
    general = c("* The symbols used in this table represent the following: 'Min' denotes the minimum time to reach the destination; 'Max' denotes the maximum time to reach the destination; 'P' indicates a percentage of the total time to reach the destination; 'Med' refers to the median time to reach the destination."),
    general_title = "Notes: ", # Title for the notes/footnotes section
    threeparttable = TRUE # Use threeparttable for better spacing of footnotes
  )
...
ggsave(file = "figure/ch03_fig_01.jpeg", 
       plot = ch03_fig_01,
       width = 17, 
       height = 22, 
       units = "in")
...
knitr::include_graphics("figure/ch03_fig_01.jpeg")
```
...
# Save the combined plot to a file
ggsave(file = "figure/ch03_fig_02.jpeg", 
       plot = ch03_fig_02,
       width = 17, 
       height = 22, 
       units = "in")
...
knitr::include_graphics("figure/ch03_fig_02.jpeg")
```
...
walking_data_filtered |> 
  dplyr::select(Destinations, 
                Impedance_Function, 
                ends_with("_1986") | ends_with("_1992") | ends_with("_1998"), -starts_with("Selected_")) |>
...
home_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Home"), aes(group = YEAR), color = "cyan3", linewidth = 1.2) +
  geom_segment(data = home_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for home destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  ...
  theme(
    ...
    panel.grid.major = element_line(color = "grey85", size = 0.2),  # Add light gray major grid lines
    panel.grid.minor = element_line(color = "grey85", size = 0.1),  # Add light gray minor grid lines
...
home_c_plot <- ggplot(cycling_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = cycling_data_f %>% filter(dest_label == "Home"), aes(group = YEAR), color = "cyan3", linewidth = 1.2) +
  geom_segment(data = home_c_peaks, aes(x = peak_c_duration, y = peak_c_ft, xend = peak_c_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of cycling for home destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
work_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Work or school"), aes(group = YEAR), color = "deeppink2", linewidth = 1.2) +
  geom_segment(data = work_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  geom_point(data = work_peaks, aes(x = peak_duration, y = peak_ft), color = "red", size = 3) +
  geom_text(data = work_peaks, aes(x = peak_duration, y = 0, label = peak_duration), color = "red", size = 3, hjust = 1.5, vjust = -0.5) +
  labs(title = "Modeling distance decay curves of walking for work or school destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
work_c_plot <- ggplot(cycling_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = cycling_data_f %>% filter(dest_label == "Work or school"), aes(group = YEAR), color = "deeppink2", linewidth = 1.2) +
  geom_segment(data = work_c_peaks, aes(x = peak_c_duration, y = peak_c_ft, xend = peak_c_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of cycling for work or school destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
ch03_fig_04 <- cowplot::plot_grid(work_plot,work_c_plot, nrow = 2, align = 'v')
...
other_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Other's home"), aes(group = YEAR), color = "darkorchid3", linewidth = 1.2) +
  geom_segment(data = other_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for other's home destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
other_c_plot <- ggplot(cycling_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = cycling_data_f %>% filter(dest_label == "Other's home"), aes(group = YEAR), color = "darkorchid3", linewidth = 1.2) +
  geom_segment(data = other_c_peaks, aes(x = peak_c_duration, y = peak_c_ft, xend = peak_c_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of cycling for other's home destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
grocery_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Grocery store, other stores or mall"), aes(group = YEAR), color = "red3", linewidth = 1.2) +
  geom_segment(data = grocery_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for Grocery store, other stores or mall destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
grocery_c_plot <- ggplot(cycling_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = cycling_data_f %>% filter(dest_label == "Grocery store, other stores or mall"), aes(group = YEAR), color = "red3", linewidth = 1.2) +
  geom_segment(data = grocery_c_peaks, aes(x = peak_c_duration, y = peak_c_ft, xend = peak_c_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of cycling for Grocery store, other stores or mall destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
outdoors_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Outdoors"), aes(group = YEAR), color = "royalblue2", linewidth = 1.2) +
  geom_segment(data = outdoors_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for outdoors destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
outdoors_c_plot <- ggplot(cycling_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = cycling_data_f %>% filter(dest_label == "Outdoors"), aes(group = YEAR), color = "royalblue2", linewidth = 1.2) +
  geom_segment(data = outdoors_c_peaks, aes(x = peak_c_duration, y = peak_c_ft, xend = peak_c_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of cycling for outdoors destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
restaurant_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Restaurant, bar or club"), aes(group = YEAR), color = "yellow2", linewidth = 1.2) +
  geom_segment(data = restaurant_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for Restaurant, bar or club destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
restaurant_c_plot <- ggplot(cycling_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = cycling_data_f %>% filter(dest_label == "Restaurant, bar or club"), aes(group = YEAR), color = "yellow2", linewidth = 1.2) +
  geom_segment(data = restaurant_c_peaks, aes(x = peak_c_duration, y = peak_c_ft, xend = peak_c_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of cycling for Restaurant, bar or club destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
place_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Place of worship"), aes(group = YEAR), color = "darkorange1", linewidth = 1.2) +
  geom_segment(data = place_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for place of worship destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
...
library_plot <- ggplot(walking_data_f, aes(x = DURATION, y = f_t)) +
  geom_line(aes(group = interaction(dest_label, YEAR)), color = "grey40", linewidth = 0.5) +
  facet_wrap(~YEAR, scales = "free_y") +
  geom_line(data = walking_data_f %>% filter(dest_label == "Library, museum or theatre"), aes(group = YEAR), color = "olivedrab4", linewidth = 1.2) +
  geom_segment(data = library_peaks, aes(x = peak_duration, y = peak_ft, xend = peak_duration, yend = 0), color = "red", linetype = "dashed", linewidth = 0.5) +
  ...
  labs(title = "Modeling distance decay curves of walking for Library, museum or theatre destination", x = "Duration (minutes)", y = "Frequency (scaled)") +
  theme_minimal(base_size = 12) +
  theme(
    plot.margin = unit(c(1, 1, 2, 1), "lines"),
    axis.line = element_line(color = "grey40"),
