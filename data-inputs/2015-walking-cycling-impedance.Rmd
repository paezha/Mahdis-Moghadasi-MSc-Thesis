...
```{r}
# Assuming you have a data frame named 'cycling_2015' with a column 'dest'

# Calculate the number of occurrences of '303' in the 'dest' column
count_303 <- sum(cycling_2015$destination == 303)

cat("The number of occurrences of '303' in the 'dest' column is:", count_303, "\n")
