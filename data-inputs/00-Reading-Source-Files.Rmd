...
Initially, we analyzed the travel time variable (DURATION) for 2015. The minimum recorded duration for walking trips is 5 minutes, while the maximum extends to 900 minutes. Furthermore, the average and median durations for walking trips are calculated to be 17.49 minutes and 10 minutes, respectively.
