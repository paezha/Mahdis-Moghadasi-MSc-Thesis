...
![Classification of required data](images/Fig.1.jpg){fig-align="center" width=90% height=60%}
...
```{r initiative,echo = FALSE, fig.cap="Example travel time decay functions by mode for work vs non work trips", out.width="0.9\\linewidth", fig.align="center"}
include_graphics(path = "images/Fig.2.jpg")
```
...
```{r surface-distance,echo = FALSE, fig.cap="Relationship between surface distance/travel time and slope", out.width="0.9\\linewidth", fig.align="center"}
include_graphics(path = "images/Fig.3.jpg")
```
