...
- \usepackage{xcolor}
params:
  Install needed packages for {thesisdown}: yes
---
...
# Load your data into an R dataframe. Make sure the path to your Excel file is correct.
walking_data <- read_excel("walking-AIC-2.xlsx")
...
# Load your data into an R dataframe
walking_data <- read_excel("walking-AIC-2.xlsx")
...
# Load your data into an R dataframe. Make sure the path to your Excel file is correct.
cycling_data <- read_excel("cycling-AIC.xlsx")
