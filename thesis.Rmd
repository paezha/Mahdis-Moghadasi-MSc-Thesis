...
```{r index-include-packages, eval=FALSE, include = FALSE}
...
```{r index-load-packages, include=FALSE}
library(macdown) # An updated R Markdown thesis template using the bookdown package
